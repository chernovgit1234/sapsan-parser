...
import { createError as createError$1, sanitizeStatusCode } from 'file://X:/sapsan/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file://X:/sapsan/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames, unpackMeta } from 'file://X:/sapsan/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://X:/sapsan/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://X:/sapsan/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://X:/sapsan/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery, withoutTrailingSlash, parseURL, withoutBase, stringifyQuery, withLeadingSlash, withBase, withTrailingSlash } from 'file://X:/sapsan/node_modules/ufo/dist/index.mjs';
import { InferSeoMetaPlugin } from 'file://X:/sapsan/node_modules/@unhead/addons/dist/index.mjs';
import { titleCase, camelCase } from 'file://X:/sapsan/node_modules/scule/dist/index.mjs';
import { defineWebSite, defineWebPage, SchemaOrgUnheadPlugin } from 'file://X:/sapsan/node_modules/@unhead/schema-org/dist/vue.mjs';
import { parse, stringify } from 'file://X:/sapsan/node_modules/devalue/index.js';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file://X:/sapsan/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-8pctHkvD.mjs')
  }
];
...
function getOgImagePath(pagePath, _options) {
  ...
  const path = joinURL("/", baseURL2, `__og-image__/${"static" }`, pagePath, `og.${options.extension}`);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C1_uRX1c.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    useHead({
      title: "Sapsan - Парсинг сайтов и каталогов",
      meta: [
        { name: "description", content: "Sapsan - личный инструмент для парсинга сайтов и каталогов, настольный парсер | sapsan parser" },
        { property: "og:title", content: "Sapsan - Парсинг сайтов и каталогов" },
        { property: "og:description", content: "Sapsan - личный инструмент для парсинга сайтов и каталогов, настольный парсер | sapsan parser" },
        { property: "og:image", content: "../../assets/img/process.jpg" },
        { name: "keywords", content: "парсер, парсинг, парсер сайтов, парсинг сайтов, парсинг каталогов, лучший парсер, быстрый парсинг, универсальный парсер, sapsan parser" }
      ]
    });
    const scrollToSection = (sectionId, offset = 100) => {
      const section = (void 0).getElementById(sectionId);
      if (section) {
        const sectionPosition = section.getBoundingClientRect().top + (void 0).pageYOffset;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, { onScrollTo: scrollToSection }, {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-3fh4MgQW.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dc6-wqDu.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-wzAJKJvK.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useNuxtApp as a, useRuntimeConfig as b, createError as c, nuxtLinkDefaults as d, entry$1 as default, useHead as e, useOgImageRuntimeConfig as f, useSiteConfig as g, injectHead as i, navigateTo as n, resolveRouteObject as r, useRouter as u };
