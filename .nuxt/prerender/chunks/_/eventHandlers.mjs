import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { createError, getQuery, handleCacheHeaders, setHeaders, setHeader, setResponseHeader, proxyRequest, sendRedirect, H3Error } from 'file://X:/sapsan/node_modules/h3/dist/index.mjs';
import { withTrailingSlash, parseURL } from 'file://X:/sapsan/node_modules/ufo/dist/index.mjs';
...
import { renderSSRHead } from 'file://X:/sapsan/node_modules/@unhead/ssr/dist/index.mjs';
import { createHeadCore } from 'file://X:/sapsan/node_modules/unhead/dist/index.mjs';
import { hash } from 'file://X:/sapsan/node_modules/nuxt-og-image/node_modules/ohash/dist/index.mjs';
import { prefixStorage } from 'file://X:/sapsan/node_modules/unstorage/dist/index.mjs';
