import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, setResponseHeaders, getRequestURL, sendRedirect, getResponseHeader, defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setHeaders, proxyRequest, getRequestHost, getRequestProtocol, getQuery as getQuery$1, createError, appendResponseHeader, removeResponseHeader, setHeader, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file://X:/sapsan/node_modules/h3/dist/index.mjs';
import { withQuery, joinURL, hasProtocol, withHttps, withoutTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withoutProtocol, withTrailingSlash, withLeadingSlash, withBase, withoutLeadingSlash, decodePath, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file://X:/sapsan/node_modules/ufo/dist/index.mjs';
...
import { createFetch, Headers as Headers$1 } from 'file://X:/sapsan/node_modules/ofetch/dist/node.mjs';
import { callNodeRequestHandler, fetchNodeRequestHandler } from 'file://X:/sapsan/node_modules/node-mock-http/dist/index.mjs';
import { toValue } from 'file://X:/sapsan/node_modules/vue/index.mjs';
...
import { parse } from 'file://X:/sapsan/node_modules/devalue/index.js';
import { hash as hash$1 } from 'file://X:/sapsan/node_modules/nuxt-og-image/node_modules/ohash/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1 } from 'file://X:/sapsan/node_modules/pathe/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://X:/sapsan/node_modules/unstorage/drivers/fs.mjs';
import file_58_47_47_47X_58_47sapsan_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47cache_45driver_46js from 'file:///X:/sapsan/node_modules/nuxt/dist/core/runtime/nitro/cache-driver.js';
import unstorage_47drivers_47fs_45lite from 'file://X:/sapsan/node_modules/unstorage/drivers/fs-lite.mjs';
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "26d36d08-83b3-47a8-82e3-35c7612a9d09",
    ...
    "routeRules": {
      ...
      "/sitemap.xml": {
        "headers": {
          ...
          "X-Sitemap-Prerendered": "2025-03-06T16:54:20.966Z"
        }
      },
      "/_nuxt": {
        "robots": "noindex",
...
storage.mount('internal:nuxt:prerender', file_58_47_47_47X_58_47sapsan_47node_modules_47nuxt_47dist_47core_47runtime_47nitro_47cache_45driver_46js({"driver":"file:///X:/sapsan/node_modules/nuxt/dist/core/runtime/nitro/cache-driver.js","base":"X:/sapsan/.nuxt/cache/nitro/prerender"}));
...
const assets = {
  "/200.html": {
    ...
    "etag": "\"4077-CqCD9/inhyyuVQdiJKyGySOruwU\"",
    "mtime": "2025-03-06T16:54:30.494Z",
    "size": 16503,
    "path": "../../.output/public/200.html"
  },
  "/404.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"403c-u0I3Gynj4Y/UWE8S/6Davh89AhM\"",
    "mtime": "2025-03-06T16:54:30.494Z",
    "size": 16444,
  ...
  "/robots.txt": {
    ...
    "etag": "\"77-Mu8SdHUN7AFmfFDn8WfkishJAwM\"",
    "mtime": "2025-03-06T16:54:30.471Z",
    "size": 119,
...
const _EARoPx = eventHandler((event) => {
...
const _lazy_raCkoF = () => import('../routes/__og-image__/font/font.mjs');
const _lazy__Xgo_N = () => import('../routes/__og-image__/image/image.mjs');
const _lazy_dho8Gs = () => import('./renderer3.mjs');

const handlers = [
  { route: '', handler: _EARoPx, lazy: false, middleware: true, method: undefined },
...
export { useOgImageRuntimeConfig as a, theme as b, useStorage as c, defineRenderHandler as d, buildAssetsURL as e, fetchIsland as f, getRouteRules as g, useRuntimeConfig as h, decodeHtml as i, toBase64Image as j, useNitroOrigin as k, logger$1 as l, htmlDecodeQuotes as m, normaliseFontInput as n, fontCache as o, publicAssetsURL as p, emojiCache as q, resolveContext as r, baseURL as s, trapUnhandledNodeErrors as t, useNitroApp as u };
