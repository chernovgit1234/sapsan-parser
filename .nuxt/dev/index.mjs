...
import { getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, setResponseHeaders, getRequestURL, sendRedirect, getResponseHeader, defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setHeaders, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getHeader, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, sendError, getResponseStatusText, H3Error } from 'file://X:/sapsan/node_modules/h3/dist/index.mjs';
import defu$1, { defu, defuFn, createDefu } from 'file://X:/sapsan/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file://X:/sapsan/node_modules/satori-html/dist/index.js';
import sizeOf from 'file://X:/sapsan/node_modules/image-size/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, hasProtocol, withHttps, withoutTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withoutProtocol, withLeadingSlash, withBase, withoutLeadingSlash, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file://X:/sapsan/node_modules/ufo/dist/index.mjs';
import consola, { consola as consola$1, createConsola } from 'file://X:/sapsan/node_modules/consola/dist/index.mjs';
...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://X:/sapsan/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, parse, uneval } from 'file://X:/sapsan/node_modules/devalue/index.js';
import destr from 'file://X:/sapsan/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://X:/sapsan/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://X:/sapsan/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin, createHeadCore } from 'file://X:/sapsan/node_modules/unhead/dist/index.mjs';
import { isVNode, toValue, unref, version } from 'file://X:/sapsan/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file://X:/sapsan/node_modules/@unhead/shared/dist/index.mjs';
import { klona } from 'file://X:/sapsan/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://X:/sapsan/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file://X:/sapsan/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file://X:/sapsan/node_modules/unstorage/drivers/lru-cache.mjs';
import { createGenerator } from 'file://X:/sapsan/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file://X:/sapsan/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { hash as hash$1 } from 'file://X:/sapsan/node_modules/nuxt-og-image/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://X:/sapsan/node_modules/radix3/dist/index.mjs';
import { createHooks } from 'file://X:/sapsan/node_modules/hookable/dist/index.mjs';
import { $fetch as $fetch$1, createFetch, Headers as Headers$1 } from 'file://X:/sapsan/node_modules/ofetch/dist/node.mjs';
import { callNodeRequestHandler, fetchNodeRequestHandler } from 'file://X:/sapsan/node_modules/node-mock-http/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { ErrorParser } from 'file://X:/sapsan/node_modules/youch-core/build/index.js';
import { Youch } from 'file://X:/sapsan/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://X:/sapsan/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://X:/sapsan/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://X:/sapsan/node_modules/errx/dist/index.js';
import devalue from 'file://X:/sapsan/node_modules/@nuxt/devalue/dist/devalue.mjs';
import Fuse from 'file://X:/sapsan/node_modules/fuse.js/dist/fuse.mjs';
import { resolve as resolve$2 } from 'file://X:/sapsan/node_modules/pathe/dist/index.mjs';
import { diffLines } from 'file://X:/sapsan/node_modules/diff/lib/index.mjs';
import MagicString from 'file://X:/sapsan/node_modules/magic-string/dist/magic-string.es.mjs';
import unstorage_47drivers_47fs from 'file://X:/sapsan/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://X:/sapsan/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import fs from 'node:fs';
import { Resvg } from 'file://X:/sapsan/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file://X:/sapsan/node_modules/satori/dist/index.js';
...
const _VudcT7xyVTSMLsTE0xM55ixGUrg5BE88lmFay9yg = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "X:/sapsan";

const appHead = {"link":[],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"titleTemplate":"%s | Sapsan Парсер","htmlAttrs":{}};
...
const _1N3l36aAxkN_WQHh2hOVxVcVYVaB3EhVrKz5yNMujM = (nitroApp) => {
...
const _wUfTcBp2w9kBlpov1wft8N5aVE3Krkerv7gtGRf9zis = defineNitroPlugin(async (nitroApp) => {
...
const _1iTfG45jhZL_xZJVtnVWTDZqCzgMVzY29qR6Ir_CJw = defineNitroPlugin(async (nitroApp) => {
...
const _inlineRuntimeConfig = {
  ...
  "nuxt-robots": {
    ...
    "sitemap": [
      "https://sapsan-parser.ru/sitemap.xml",
      "/sitemap.xml"
    ],
    "header": true,
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"X:/sapsan/.nuxt/cache/nuxt-og-image@4.2.0/_fonts"},{"baseName":"server","dir":"X:/sapsan/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"X:/sapsan"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"X:/sapsan/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"X:/sapsan/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"X:/sapsan/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"X:/sapsan/.data/kv"}));
...
const componentNames = [{"hash":"MlnXt-4pSsc-S0S-NyO1mjaxwp9hRjHjCY9kvDedhdQ","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"fpeX9mEOdoiwmgFVE7hebxqWjsIhD1kTbNd-q3hCd44","pascalName":"Frame","kebabName":"frame","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"iEMfMtE3Z-GRD7M8UdLMA8z5kz-STiQ6hixM09D2-dU","pascalName":"Nuxt","kebabName":"nuxt","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community","credits":"NuxtLabs <https://nuxtlabs.com/>"},{"hash":"OPSMK5e1Mj-B-KLuoxjOG3CTzYq1s5ld-uvugb--Fog","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community","credits":"Nuxt SEO <https://nuxtseo.com/>"},{"hash":"9zhUtkB6optlrF0l5DEhgmR2EaIfGQP-Opy1PHC-ea0","pascalName":"Pergel","kebabName":"pergel","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community","credits":"Pergel <https://nuxtlabs.com/>"},{"hash":"elBNvk6E8lXN8E9YywMD9ZKEiLvF8lfcfuj7SBFp5UI","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"NZaFkzgYlwbuyTVFd6EHH-xQWdLAvf9XnrhiwGpu4Sg","pascalName":"UnJs","kebabName":"un-js","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"QXHbDpwVYCs3sUZl2lD4T9ynY6wsyAvK7oqRs1B0wsI","pascalName":"Wave","kebabName":"wave","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"6osD1f2PCUicjON4dfrsnxhXzikrQ0yfi43nndOjEuY","pascalName":"WithEmoji","kebabName":"with-emoji","path":"X:/sapsan/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"}];
...
const _MqDDkFmCP3oxtgbFZayNZ3qADS9lnBWijsnzyxeJUJM = defineNitroPlugin(async (nitro) => {
  return;
});

const plugins = [
  _VudcT7xyVTSMLsTE0xM55ixGUrg5BE88lmFay9yg,
_1N3l36aAxkN_WQHh2hOVxVcVYVaB3EhVrKz5yNMujM,
_wUfTcBp2w9kBlpov1wft8N5aVE3Krkerv7gtGRf9zis,
_1iTfG45jhZL_xZJVtnVWTDZqCzgMVzY29qR6Ir_CJw,
_MqDDkFmCP3oxtgbFZayNZ3qADS9lnBWijsnzyxeJUJM
];

const _rqrnaN = defineEventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _J3t598 = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _DkJeON = defineEventHandler(async (e) => {
...
const _Wrf3v_ = defineEventHandler(async (e) => {
...
const _6V_s9Q = defineEventHandler(async (e) => {
...
const _pdYNCm = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const _3vuIor = defineEventHandler(async (e) => {
...
const _sL2hbI = defineEventHandler(async (e) => {
...
const _vNHABs = defineEventHandler(async (e) => {
...
const _Bi3pU8 = defineEventHandler(async (e) => {
  const nitroOrigin = useNitroOrigin(e);
  return {
    nitroOrigin,
...
const _N2v9dt = defineEventHandler(async (e) => {
...
const _h2YjcY = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _AUmjnF = defineEventHandler(async (e) => {
  return {
...
const _J04QUe = defineEventHandler(async (e) => {
...
const _lazy_dho8Gs = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_raCkoF = () => Promise.resolve().then(function () { return font$1; });
const _lazy_r6jFme = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy__Xgo_N = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_dho8Gs, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _rqrnaN, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _J3t598, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _DkJeON, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _Wrf3v_, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _6V_s9Q, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _pdYNCm, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _3vuIor, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _sL2hbI, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _vNHABs, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_raCkoF, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_r6jFme, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy__Xgo_N, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy__Xgo_N, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _Bi3pU8, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _N2v9dt, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _h2YjcY, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _AUmjnF, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _J04QUe, lazy: false, middleware: true, method: undefined },
  { route: '/_fonts/**', handler: _lazy_dho8Gs, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dho8Gs, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://X:/sapsan/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://X:/sapsan/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
